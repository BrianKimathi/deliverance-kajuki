  ...
  return (
    <main className="bg-gray-50 min-h-screen py-12 px-4">
      <section className="max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-extrabold text-center mb-6" style={{ color: logoColor }}>Pastoral Care Requests</h1>
        <p className="text-lg text-center text-gray-700 mb-8">Request compassionate care and support from our pastoral team.</p>
        <form className="bg-white rounded-xl shadow-lg p-8 flex flex-col gap-4">
          ...
          <textarea placeholder="Your Pastoral Care Request" className="px-4 py-2 rounded bg-gray-100 text-black focus:outline-none min-h-[80px]" />
